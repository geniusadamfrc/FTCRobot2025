...
public class BlueShoot6Pickup3Pedro extends BaseAutoCommand {
    ...
    public Command getMainCommand(){
        ...
        MecanumImpl pedro =  Constants.createMecanumImpl(hardwareMap);
        Follower follower = Constants.createFollowerRobot(hardwareMap, pedro);
        ...
        sq1.addCommand(new DriveStraightPedro(Robot.drivetrain, follower, pedro,-36, telemetry));
