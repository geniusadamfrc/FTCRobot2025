...
public final class TuningOpModes {
    ...
    private static PinpointView makePinpointView(PinpointLocalizer pl) {
        return new PinpointView() {
            ...
            GoBildaPinpointDriver.EncoderDirection perpDirection = GoBildaPinpointDriver.EncoderDirection.REVERSED;
    ...
    public static void register(OpModeManager manager) {
        ...
        DriveViewFactory dvf = hardwareMap -> {
            Robot.init(hardwareMap, null, null, null);
            MecanumDrive md = Robot.drivetrain.roadRunnerController;
            ...
            return new DriveView(
                DriveType.MECANUM,
                    ...
                    encoderGroups,
                    Arrays.asList(
                            Robot.drivetrain.leftFrontDrive,
                            Robot.drivetrain.leftBackDrive
                    ),
                    Arrays.asList(
                            Robot.drivetrain.rightFrontDrive,
                            Robot.drivetrain.rightBackDrive
                    ),
                    leftEncs,
                    rightEncs,
                    parEncs,
